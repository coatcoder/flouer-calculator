...
st.subheader('_Неоптимизированная версия_') # Тут мне стало стыдно за грамматические ошибки 
get_flower()
names = []
...
st.write("Цена за 10 шт. : ", float(value), "Цена без наценки : ", izn, "Цена с наценкой: ", itog)
